...
**Implication:**\
Weather sets baseline demand levels, acting as a modifier rather than a sole determinant of ridership.
...
**Implication:**\
Rider type explains *who* drives demand patterns, but not individual decision-making motives.
...
**Implication:**\
Infrastructure strongly shapes *where* demand concentrates, but causal claims require more rigorous designs.
...
**Implication:**\
Time variables establish the structural rhythm of demand, onto which other factors act.
...
**Implication:**\
Technology choice amplifies existing demand patterns, modifying how riders respond to fatigue and infrastructure rather than replacing core behaviors.
